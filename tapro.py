...
def create_embed(title, description="", color=0x1a1a1a, fields=None):
    ...
    embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/1424364949370703872/1451465176569090169/logo.png?ex=694645c9&is=6944f449&hm=6da127ba667d49e853954a25bc9c2fadb9c5d98ae58000088321686ed525f995&")
    ...
    embed.set_footer(text=f"TaproCloud  VPS Manager • {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}",
                    icon_url="https://cdn.discordapp.com/attachments/1424364949370703872/1451465176917475400/ChatGPT_Image_Jul_23_2025_03_03_39_PM.png?ex=694645c9&is=6944f449&hm=becf8524a6ad5f03d6450e675e4038e6edbcf1a25db8edda8da347a4dd6e43bd&")
...
async def on_ready():
    ...
    await bot.change_presence(activity=discord.Activity(type=discord.ActivityType.watching, name=" TaproCloud VPS Manager"))
...
class ManageView(discord.ui.View):
    ...
    def add_action_buttons(self):
        ...
        ssh_button.callback = lambda inter: self.action_callback(inter, '
        ...
        if action == 'reinstall':
            ...
            try:
                ...
                if check_proc.returncode != 0:
                    ...
                    await execute_lxc(
    f"lxc exec {container_name} -- sudo apt-get update -y"
)

await execute_lxc(
    f"lxc exec {container_name} -- sudo apt-get install -y software-properties-common"
)

await execute_lxc(
    f"lxc exec {container_name} -- sudo add-apt-repository universe -y"
)
...
await execute_lxc(
    f"lxc exec {container_name} -- sudo apt-get install -y tmate"
)
...
async def show_plans(ctx):
    ...
    embed = create_embed("💎 VPS Plans - TaproCloud ", "Choose your perfect VPS plan:", 0x1a1a1a)
...
async def show_help(ctx):
    ...
    embed = create_embed("📚 Command Help", "TaproCloud  VPS Manager Commands:", 0x1a1a1a)
    ...
    embed.set_footer(text="TaproCloud VPS Manager • No auto-shutdown • Clean performance")
    await ctx.send(embed=embed)
